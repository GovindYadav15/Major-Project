...
class _$NewsArticleImpl implements _NewsArticle {
  ...
  @override
  String toString() {
    return 'NewsArticle(id: $id, title: $title, description: $description, content: $content, imageUrl: $imageUrl, category: $category, publishedAt: $publishedAt, source: $source)';
  }
